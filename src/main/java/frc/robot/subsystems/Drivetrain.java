...
public class Drivetrain extends SubsystemBase {
  ...
  public void log() {
    ...
    SmartDashboard.putNumber("Velocity",
        (rightFather.getSelectedSensorVelocity() + leftFather.getSelectedSensorVelocity()) / 2.0);
  ...
  public void rad(final double num) {
  ...
  public void setRightVelocity(final double velocity) {
    rightFather.set(ControlMode.Velocity, velocity);
  }

  public void setLeftVelocity(final double velocity) {
    leftFather.set(ControlMode.Velocity, velocity);
  }

  public void setVelocity(final double left, final double right) {
    setLeftVelocity(left);
    setRightVelocity(right);
  }

  public void setRightGoal(final double rightGoal) {
    this.rightGoal = rightGoal + rightFather.getSelectedSensorPosition();
  }

  public void setRightPosition(final double Position) {
  ...
  public void resetOdometry(final Pose2d pose) {
    resetEncoders();
    //m_odometry.resetPosition(pose, m_gyro.getRotation2d()); TODO fix this
  }
